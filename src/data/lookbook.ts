...
export const lookbook: Look[] = [
  ...
  },
  {
    ...
    addOnPrice: 'Included with colour',
    additionalTime: '0 min',
    suggestedBaseTreatment: 'signature-gel',
    artist: 'Maya Fraser',
  ...
  },
  {
    ...
    addOnPrice: 'Base treatment',
    additionalTime: '60 min',
  ...
  },
  {
    ...
    category: 'Occasion',
    complexity: 'Medium',
    description: 'A precise evening finish with a shorter natural shape.',
    addOnPrice: 'Included with colour',
    additionalTime: '0 min',
    suggestedBaseTreatment: 'signature-gel',
    artist: 'Isla Morgan',
  ...
  },
  {
    ...
    addOnPrice: 'from +£20',
    additionalTime: '+30 min',
    suggestedBaseTreatment: 'soft-gel-extensions',
    addOn: 'detailed-art',
    artist: 'Isla Morgan',
    alt: 'Nail technician applying a precise finish during a manicure.',
  },
];
